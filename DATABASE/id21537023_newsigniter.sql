...
--
-- Host: localhost:3306
-- Generation Time: Apr 23, 2024 at 04:20 AM
...
--
-- Database: `id21537023_newsigniter`
--
...
(1, '::1', 'admin', 1713779438),
(2, '::1', 'admin', 1713779443);
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `role`) VALUES
(1, '127.0.0.1', 'administrator', '$2y$12$QUM2OeQCZclQqJIhZKKMt.Aq8dA3Y7eIzjtXsyr.xuE0kDjfj8SLS', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1621754450, 1, 'Will', 'Williams', 'CodeAstro', '0123456789', 'admin');
