...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE) {
			...
			if ($this->validateUser($identity, $password)) {
	...
	// Example function to validate user against database
	private function validateUser($identity, $password)
	{
		// Load database library
		$this->load->database();

		// Prepare SQL statement to retrieve user record based on username/email
